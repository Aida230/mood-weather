    ...
    <div id="banner" className="bg-black text-white py-16 px-6 sm:px-12 space-y-24">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative p-6 sm:p-10 border-r border-b border-blue-400">
          <p className="uppercase text-blue-400 text-sm mb-2">NUESTRA TECNOLOGÍA</p>
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Herramientas de Seguimiento Meteorológico de Precisión</h1>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative p-6 sm:p-10 border-r border-b border-blue-400 order-2 md:order-1">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Monitoreando el Clima de la Tierra desde el Espacio</h1>
          <p className="text-gray-300 text-sm sm:text-base leading-relaxed mb-4">
